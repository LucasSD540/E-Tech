...
from .views import LoginView, LogoutView, CookieTokenRefreshView, UserCreateView, UserListView, UserDetailView, UserUpdateView, UserDeleteView, user_info
...
urlpatterns = [
    ...
    path('auth/me/', user_info, name="authenticated-account"),
