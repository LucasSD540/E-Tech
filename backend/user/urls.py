...
from .views import LoginView, LogoutView, CookieTokenRefreshView, UserCreateView, UserListView, UserDetailView, UserUpdateView, UserDeleteView, CheckIsAuth, PasswordResetRequestView, PasswordResetConfirmView, ChangePasswordView
...
urlpatterns = [
    ...
    path('update/', UserUpdateView.as_view(), name="update-account"),
